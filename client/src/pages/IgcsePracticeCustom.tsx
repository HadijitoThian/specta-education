...
const TOPIC_HINTS = [
  ...
  { code: "1.13", name: "Percentages" },
  { code: "1.11", name: "Ratio and proportion" },
  { code: "1.10", name: "Bounds" },
  { code: "1.7",  name: "Indices" },
  { code: "1.8",  name: "Standard form" },
  { code: "2.2",  name: "Algebra manipulation" },
  { code: "2.6",  name: "Quadratic equations" },
  { code: "2.10", name: "Functions" },
  { code: "2.14", name: "Differentiation" },
  { code: "4.4",  name: "Similarity" },
  { code: "4.8",  name: "Circle theorems" },
  { code: "5.5",  name: "Volume" },
  { code: "6.1",  name: "Pythagoras" },
  { code: "6.2",  name: "Right-angled trigonometry" },
  { code: "7.1",  name: "Transformations" },
  { code: "8.1",  name: "Probability" },
  { code: "9.6",  name: "Cumulative frequency" },
];
