...
const UNIVERSITY_DATA: Record<string, { name: string; flag: string; universities: string[] }> = {
  malaysia: { name: "Malaysia", flag: "\ud83c\uddf2\ud83c\uddfe", universities: ["Taylor's University", "UCSI University", "Monash University Malaysia", "University of Nottingham Malaysia", "University of Southampton Malaysia", "The One Academy", "MILA University"] },
