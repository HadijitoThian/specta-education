  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="https://wa.me/62819668278?text=Hi,%20I'd%20like%20a%20free%20IELTS%20consultation" target="_blank" rel="noopener noreferrer">
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-40 bg-gradient-to-r from-rose-500 to-purple-600 hover:from-rose-600 hover:to-purple-700 text-white rounded-2xl p-4 shadow-xl shadow-rose-200/50"
