      ...
      <main className="max-w-5xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className={`${card} p-6`}>
          ...
          <p className="text-[11px] text-slate-400 mt-2">
            All questions are authored to Cambridge IGCSE {subject === "physics" ? "0625 (Physics)" : subject === "economics" ? "0455 (Economics)" : subject === "business" ? "0450 (Business Studies)" : subject === "chemistry" ? "0620 (Chemistry)" : "0580 (Math)"} style — not verbatim past papers.
          </p>
