        ...
        <div className="grid md:grid-cols-4 gap-12">
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://wa.me/62818218388" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-background/10 rounded-full flex items-center justify-center hover:bg-background/20 transition-colors" aria-label="WhatsApp">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-background/70">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+62818218388" className="hover:text-background transition-colors">+62 818 218 388</a>
              </li>
              <li className="flex items-center gap-2">
