        ...
        <div className="grid md:grid-cols-4 gap-12">
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a href="https://www.instagram.com/spectaedu/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-background/10 rounded-full flex items-center justify-center hover:bg-background/20 transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@spectaeducation" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-background/10 rounded-full flex items-center justify-center hover:bg-background/20 transition-colors" aria-label="TikTok">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 0010.86 4.43v-7.15a8.16 8.16 0 005.58 2.18V11.2a4.85 4.85 0 01-3.77-1.74V6.69h3.77z"/></svg>
              </a>
              <a href="https://wa.me/6281181208 20" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-background/10 rounded-full flex items-center justify-center hover:bg-background/20 transition-colors" aria-label="WhatsApp">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-background/70">
              ...
              <li><Link href="/scholarships" className="hover:text-background transition-colors">🎓 Scholarships</Link></li>
              <li><Link href="/play" className="hover:text-background transition-colors">🎮 SpecTa Play</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-background/70">
              ...
              <li><Link href="/destinations/ireland" className="hover:text-background transition-colors">🇮🇪 Ireland</Link></li>
              <li><Link href="/destinations" className="hover:text-background transition-colors">View All &rarr;</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-3 text-sm text-background/70">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+6281181208 20" className="hover:text-background transition-colors">+62 811 8120 820</a>
              </li>
              <li className="flex items-center gap-2">
