        ...
        <div className="grid md:grid-cols-4 gap-12">
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a href="https://www.instagram.com/spectaeducation/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-background/10 rounded-full flex items-center justify-center hover:bg-background/20 transition-colors" aria-label="Instagram">
              ...
              <a href="https://wa.me/62819668278" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-background/10 rounded-full flex items-center justify-center hover:bg-background/20 transition-colors" aria-label="WhatsApp">
