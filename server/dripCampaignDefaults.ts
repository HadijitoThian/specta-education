    ...
    if (contactCampaign) {
      await createDripEmailStep({
        ...
        htmlContent: wrapEmailTemplate(`
          ...
          <div style="text-align: center; margin: 24px 0;">
            <a href="https://wa.me/62819668278?text=Hi%20SpecTa!%20Saya%20ingin%20konsultasi%20tentang%20kuliah%20di%20luar%20negeri" style="display: inline-block; background: #25D366; color: white; text-decoration: none; padding: 14px 32px; border-radius: 12px; font-weight: 600; font-size: 16px;">💬 Chat via WhatsApp</a>
          </div>
        `),
      });
      ...
      await createDripEmailStep({
        ...
        htmlContent: wrapEmailTemplate(`
          ...
          <div style="text-align: center; margin: 24px 0;">
            <a href="https://wa.me/62819668278?text=Hi%20SpecTa!%20Saya%20ingin%20jadwalkan%20konsultasi%20gratis" style="display: inline-block; background: #e53e3e; color: white; text-decoration: none; padding: 14px 32px; border-radius: 12px; font-weight: 600; font-size: 16px;">📅 Jadwalkan Konsultasi Gratis</a>
          </div>
    ...
    if (scholarshipCampaign) {
      await createDripEmailStep({
        ...
        htmlContent: wrapEmailTemplate(`
          ...
          <div style="text-align: center; margin: 24px 0;">
            <a href="https://wa.me/62819668278?text=Hi%20SpecTa!%20Saya%20tertarik%20dengan%20beasiswa%20dan%20ingin%20konsultasi" style="display: inline-block; background: #10b981; color: white; text-decoration: none; padding: 14px 32px; border-radius: 12px; font-weight: 600; font-size: 16px;">💬 Konsultasi Beasiswa</a>
          </div>
        `),
      });
