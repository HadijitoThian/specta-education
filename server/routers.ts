...
import("./db").then(async m => {
  ...
  try {
    const r9 = await seedIgcseChemistryTopicsIfEmpty();
    if (r9.seeded) console.log(`[IGCSE] Seeded ${r9.seeded} Chemistry topics`);
  } catch (e) { console.error('[IGCSE] Chemistry topic seed error:', e); }
  try {
